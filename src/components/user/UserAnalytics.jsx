                ...
                <AnalyticsCard title="Spending Distribution">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            ...
                            <Legend iconType="circle" layout="vertical" align="right" verticalAlign="middle" wrapperStyle={{ fontSize: '10px', paddingLeft: '10px' }} />
                            <text x="50%" y="48%" textAnchor="middle" dominantBaseline="middle" className="fill-white text-lg font-black italic font-mono">
                                {formatCurrency(totalSpend)}
                            </text>
                            <text x="50%" y="56%" textAnchor="middle" dominantBaseline="middle" className="fill-slate-500 text-[10px] font-bold uppercase tracking-widest">
                                Total Outflow
                            </text>
                        </PieChart>
                    </ResponsiveContainer>
